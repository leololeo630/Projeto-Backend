...
// Middleware para disponibilizar dados da sessão nos templates
...
async function iniciarServidor() {
  try {
    ...
    app.listen(PORT, () => {
      Logger.registrarInfo(`Servidor com Templates iniciado na porta ${PORT}`);
      console.log(`🚀 Servidor com Templates rodando em http://localhost:${PORT}`);
      console.log(`📱 Acesse: http://localhost:${PORT}`);
    });

  } catch (erro) {
    Logger.registrarErro('Erro ao iniciar o servidor com templates', erro);
...
process.on('SIGINT', async () => {
  Logger.registrarInfo('Encerrando servidor com templates...');
  console.log('\n🛑 Encerrando servidor...');
